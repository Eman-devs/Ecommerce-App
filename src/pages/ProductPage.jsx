    ...
    <section className="text-gray-600 body-font overflow-hidden">
      <div className="container px-5 py-24 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap" >
          <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 border border-opacity-50 object-cover object-center rounded" src={product.image}  />
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <div className="flex justify-between">
              ...
              <div className="flex">
              <button className="flex ml-auto text-white bg-green-500 border-0 py-2 px-6 focus:outline-none hover:bg-green-600  mr-2 rounded">Buy it now</button>
              <button className="flex ml-auto border border-green-500  py-2 px-6 focus:outline-none hover:bg-green-600  hover:text-white rounded">Add to card</button>
              </div>
